...
class UserAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        ...
        if ($request->headers->get('referer') === $this->urlGenerator->generate('app_pre_reservation')) {
            // Redirigez vers la page de modification de profil
            return new RedirectResponse($this->urlGenerator->generate('app_utilisateur_profile'));
        }app_utilisateur_profile
