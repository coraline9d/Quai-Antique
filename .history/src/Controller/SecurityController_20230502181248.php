...
class SecurityController extends AbstractController
{
    ...
    {
        // call logiconly method
        $response = $this->logiconly($authenticationUtils);

        return $this->render('security/login.html.twig', ['response' => $response, 'last_username' => $lastUsername, 'error' => $error]);
    }
    ...
    public function reservation(AuthenticationUtils $authenticationUtils): Response
    {
        ...
        return $this->render('security/login_form_only.html.twig', ['response' => $response]);
    }
